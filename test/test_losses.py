...
for _ in range(batch_size):
    y_xy = tf.random.uniform(shape=(num_scale, 6, 2), minval=0, maxval=fmaps_shape[0], dtype=tf.int32)
...
#    拿负责预测的anchors
liable_anchors = takeout_liable_anchors(liable_cells, y_true_liable, fmaps_shape, num_classes, num_anchors)
# print('\n负责预测的anchors')
...
loss_box = yolo_loss.loss_box(liable_anchors, num_classes)
loss_confidence = yolo_loss.loss_confidence(liable_anchors, num_classes)
loss_cls = yolo_loss.loss_cls(liable_anchors, num_classes)
